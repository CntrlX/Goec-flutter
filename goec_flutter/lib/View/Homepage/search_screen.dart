                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomText(
                                        text:
                                            '${(MapFunctions.distanceBetweenCoordinates(MapFunctions().curPos.latitude, MapFunctions().curPos.longitude, controller.search_list[index].latitude, controller.search_list[index].longitude) / 1000.0).toPrecision(2)} km',
                                        size: 10,
