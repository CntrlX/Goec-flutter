              ...
              Container(
                child: Container(
                  ...
                  child: GoogleMap(
                    ...
                    onTap: (value) {
                      if (controller.source.value.placeId != null &&
                          controller.destination.value.placeId != null) {
                            ...
                            () => rounded_container(
                              ...
                              text: controller.destination.value.placeId == null
                                  ...
                                  : controller.destination.value.description!
                                      .split(', ')
                                      .first,
                              onTap: () => controller.getDestination(),
                            ),
                          ),
                        ],
                      ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      CustomBigText(
                        text: "${controller.stationList.length} Stations",
                        size: 12,
                        color: Color(
                          0xff0047C3,
                        ),
